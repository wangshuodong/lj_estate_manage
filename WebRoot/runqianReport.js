function runqianReport( width, height ) {
	...
	var s = "<iframe name=\"" + name + "\" width=" + width + " height=" + height + " frameborder=0 style=\"";
	s += "background-color:white\"></iframe>";
	document.write( s );
...
function rr_display() {
	var url = this.serverURL + "/showReport4web.jsp?file=" + urlEncode( this.file ) + "&scale=" + this.scale;
	...
	if( this.saveAsName.length > 0 ) url += "&saveAsName=" + this.saveAsName;
