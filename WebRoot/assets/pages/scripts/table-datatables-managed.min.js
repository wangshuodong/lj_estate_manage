    ...
    var e = function () {
        ...
        e.dataTable({
            ...
            initComplete: function () {
                this.api().column(1).every(function () {
                    var e = this, t = $('<select class="form-control input-sm"><option value="">Select</option></select>').appendTo($(e.footer()).empty()).on("change", function () {
        ...
        e.dataTable({
            language: {
                ...
                search: "查询:",
                zeroRecords: "没有数据",
                paginate: {previous: "上一页", next: "下一页", last: "最后一页", first: "第一页"}
            },
            bStateSave: !0,
        ...
        e.dataTable({
            ...
            footerCallback: function (e, t, a, r, o) {
                var n = this.api(), s = function (e) {
                    return "string" == typeof e ? 1 * e.replace(/[\$,]/g, "") : "number" == typeof e ? e : 0
                };
                total = n.column(3).data().reduce(function (e, t) {
                    return s(e) + s(t)
                }, 0), pageTotal = n.column(3, {page: "current"}).data().reduce(function (e, t) {
                    return s(e) + s(t)
                }, 0), $(n.column(3).footer()).html("$" + pageTotal + " ( $" + total + " total)")
            },
            bStateSave: !0,
            lengthMenu: [[6, 15, 20, -1], [6, 15, 20, "All"]],
            pageLength: 6,
