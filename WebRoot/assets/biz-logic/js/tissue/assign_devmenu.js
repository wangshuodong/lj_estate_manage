$(function() {
            ...
            onDblClick : function(event, treeId, treeNode){
                $.post('role_menus.html',{roleId: treeNode.roleId},function(r){
                    if(r.r) {
                        ...
                        $('#devtitleRoleName').text(' - ' + treeNode.roleName);
                        $('#devtitleRoleName').data('roleId', treeNode.roleId).data('trigger',false);
    ...
    var othersetting = {
        ...
        callback : {
            ...
            onCheck:function(event, treeId, treeNode){
                $.post('menu_checked.html',{roleId:$('#devtitleRoleName').data('roleId'),menuId:treeNode.menuId,checked:treeNode.checked},
                		function(r){console.log(r.m);},'json');
            },
            beforeCheck:function(treeId, treeNode){
                if($('#devtitleRoleName').data('roleId')){
                    return true;
                }else {
    ...
    $.fn.zTree.init($("#devmenuPanel"), othersetting, window.devmenusJson);
    menuTree = $.fn.zTree.getZTreeObj("devmenuPanel");
